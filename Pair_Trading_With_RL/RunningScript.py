#Citation:
#Wai-i (2018) Pair-Trading-Reinforcement-Learning source code (Version 1.0) [Source code]. https://github.com/wai-i/Pair-Trading-Reinforcement-Learning
...
config_train = read_yaml(config_path)

# Read stock pairs prices
x = pd.read_csv('stock1.csv')
y = pd.read_csv('stock2.csv')
...
# Plot the testing result and save to csv file
#pd.set_option('display.max_rows', None)
#print(pnl)
pnl['PnL'] = (pnl['Trade_Profit'] - pnl['Cost']).cumsum()
pnl.to_csv('test1.csv', index=False)
plt.plot(pnl['PnL'])
